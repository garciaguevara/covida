...
def voronoiAdminRegionContainMunicipalities(muniCasesPts, tReg, tGeoLoc, tGeoLocName):    
...
def adminRegionsByMunicipalities(casosCentroidsDF, tReg, tGeoLoc,tGeoLocName):
    muniCasesPts=np.array([list(casosCentroidsDF['X'].values),list(casosCentroidsDF['Y'].values)]); muniCasesPts=muniCasesPts.transpose()
    
    #################################################################################################################################################################
    muniPolyIDs, muniPolyAdminNames, muniPolyPositionsX, muniPolyPositionsY=voronoiAdminRegionContainMunicipalities(muniCasesPts,tReg, tGeoLoc, tGeoLocName)
...
def mobAdminRegion(dayRange,allMobi,joinByMobGeo): #TODO: factorize
    #TODO: Update mobility with varying range
    ...
    return tReg, tGeoLoc,tGeoLocName, tLargerChangeLoc, adminRegPerDay
...
def getMetroAreaAdminRegions(MetroArea):                
    if  os.path.exists( metroAreasCSV.replace('.csv',MetroArea+"AdminReg.pkl") ):   
        ...
        tReg, tGeoLoc,tGeoLocName, tLargerChangeLoc, adminRegPerDay=mobAdminRegion(dayRange,allMobi,joinByMobGeo)
        
        muniPolyIDs, muniPolyAdminNames, muniPolyPositionsX, muniPolyPositionsY=voronoiAdminRegionContainMunicipalities(munisMetroPts, tReg,tGeoLoc, tGeoLocName)   
...
def main():
    ...
    adminRegionsByMunicipalities(casosCentroidsDF,tReg, tGeoLoc,tGeoLocName)
    
    
    getMetroAreaAdminRegions(MetroArea)  
